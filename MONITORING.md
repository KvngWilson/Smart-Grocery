...
Complete observability stack for Smart Grocery Manager featuring:
...
kubectl port-forward -n smart-grocery svc/grafana 3000:3000
...
### Smart Grocery Manager Dashboard
...
# Or via kubectl
kubectl logs -n smart-grocery -l app=prometheus | grep -i alert
```
...
docker logs smart-grocery-prometheus
...
docker exec smart-grocery-redis-exporter redis-cli -h redis ping

# View exporter logs
docker logs smart-grocery-redis-exporter
